...
const editableValueSchema = z.object({
...
function EditableValueForm({
  ...
  const form = useForm<z.infer<typeof editableValueSchema>>({
    resolver: zodResolver(editableValueSchema),
    defaultValues: { value },
  })
...
const columns = columnHelper.columns([
  ...
  columnHelper.accessor("target", {
    ...
    cell: ({ row }) => <EditableValueForm id={`${row.original.id}-target`} label={`Target for ${row.original.header}`} value={row.original.target} />,
  }),
  columnHelper.accessor("limit", {
    header: () => <div className="w-full text-right">Limit</div>,
    cell: ({ row }) => <EditableValueForm id={`${row.original.id}-limit`} label={`Limit for ${row.original.header}`} value={row.original.limit} />,
  }),
  ...
  return (
    <Drawer swipeDirection={isMobile ? "down" : "right"}>
      ...
      <DrawerContent>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          ...
          <form className="flex flex-col gap-4" onSubmit={form.handleSubmit(submit)}>
            <div className="flex flex-col gap-3">
              ...
              <Input id="header" aria-invalid={Boolean(form.formState.errors.header)} {...form.register("header")} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="type">Type</Label>
                <Controller control={form.control} name="type" render={({ field }) => <Select
                  value={field.value}
              ...
              <div className="flex flex-col gap-3">
                ...
                <Controller control={form.control} name="status" render={({ field }) => <Select
                  value={field.value}
                  onValueChange={field.onChange}
                  items={[
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input id="limit" aria-invalid={Boolean(form.formState.errors.limit)} {...form.register("limit")} />
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">Reviewer</Label>
              <Controller control={form.control} name="reviewer" render={({ field }) => <Select
                value={field.value}
                onValueChange={field.onChange}
                items={[
                  { label: "Eddie Lake", value: "Eddie Lake" },
        ...
        <DrawerFooter>
          <Button onClick={form.handleSubmit(submit)}>Submit</Button>
